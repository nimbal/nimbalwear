    ...
    if type == 'daily':
        ...
        for s in sptw_inc:
            ...
            for date in dates:
                ...
                day_sleep_stats = pd.DataFrame([[day_num, date, type, s, total_sptw_duration, total_sleep_duration,
                                             sleep_to_wake_duration, sleep_eff, waso]], columns=sleep_stats.columns)
